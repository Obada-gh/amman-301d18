...
// 1. What is "this" when joe.scope() is invoked? wondow.object
//
// 2. What is "this" when joe.scopeArrow() is invoked? undefined
//
// 3. Explain why "this" is different when an arrow function is used ? Does not have its own bindings to this or super, and should not be used as methods
//
